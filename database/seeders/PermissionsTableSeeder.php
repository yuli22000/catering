...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //permission colors
        Permission::create(['name' => 'mixes.index', 'guard_name' => 'web']);
        Permission::create(['name' => 'mixes.create', 'guard_name' => 'web']);
        Permission::create(['name' => 'mixes.edit', 'guard_name' => 'web']);
        Permission::create(['name' => 'mixes.delete', 'guard_name' => 'web']);
