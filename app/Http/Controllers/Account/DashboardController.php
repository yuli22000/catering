...
class DashboardController extends Controller
{
    ...
    {
        //count transactions
        $unpaid     = Transaction::where('status_shiping', 'menunggu')->count();
        $paid       = Transaction::where('status_shiping', 'diterima')->count();
        $expired    = Transaction::where('status_shiping', 'delivery')->count();
        $cancelled  = Transaction::where('status_shiping', 'cancel')->count();
