        ...
        <>
            <div className="list-group list-group-flush">
                ...
                {hasAnyPermission(['products.index']) && 
                    <Link href="/account/products" className={`${ url.startsWith('/account/products') ? "active list-group-item list-group-item-action list-group-item-light p-3" : "list-group-item list-group-item-action list-group-item-light p-3"}`}><i className="fa fa-shopping-bag me-2"></i> Menu Catering</Link>
                }
                ...
                {hasAnyPermission(['banks.index']) && 
                    <Link href="/account/banks" className={`${ url.startsWith('/account/banks') ? "active list-group-item list-group-item-action list-group-item-light p-3" : "list-group-item list-group-item-action list-group-item-light p-3"}`}><i className="fa fa-images me-2"></i> Bank</Link>
                }
                ...
                {hasAnyPermission(['users.index']) && 
                    ...
                    <Link href="/logout" onClick={logoutHandler} className={`${ url.startsWith('/logout') ? "active list-group-item list-group-item-action list-group-item-light p-3" : "list-group-item list-group-item-action list-group-item-light p-3"}`}><i className="fa fa-users me-2"></i> Logout</Link>
