...
export default function Dashboard() {
    ...
    return (
        <>
            <Head>
                <title>Dashboard - Catering Aisyah</title>
            </Head>
            <LayoutAccount>
                        ...
                        <div className="col-12 col-lg-3 mb-4">
                            <div className="card border-0 shadow-sm overflow-hidden">
                                <div className="card-body p-0 d-flex align-items-center">
                                    ...
                                    <div>
                                        <div className="text-value text-primary">{count.menunggu}</div>
                        ...
                        <div className="col-12 col-lg-3 mb-4">
                            <div className="card border-0 rounded shadow-sm overflow-hidden">
                                <div className="card-body p-0 d-flex align-items-center">
                                    ...
                                    <div>
                                        <div className="text-value text-success">{count.diterima}</div>
                                        <div className="text-muted text-uppercase font-weight-bold small">
                                            PAID
                                        </div>
                                    </div>
                        ...
                        <div className="col-12 col-lg-3 mb-4">
                            <div className="card border-0 rounded shadow-sm overflow-hidden">
                                <div className="card-body p-0 d-flex align-items-center">
                                    ...
                                    <div>
                                        <div className="text-value text-warning">{count.delivery}</div>
                                        <div className="text-muted text-uppercase font-weight-bold small">
                                            DELIVERY
                                        </div>
                                    </div>
                        ...
                        <div className="col-12 col-lg-3 mb-4">
                            <div className="card border-0 rounded shadow-sm overflow-hidden">
                                <div className="card-body p-0 d-flex align-items-center">
                                    ...
                                    <div>
                                        <div className="text-value text-danger">{count.cancel}</div>
                                        <div className="text-muted text-uppercase font-weight-bold small">
                                            CANCELLED
                                        </div>
                                    </div>
