...
export default function ProductCreate() {
    ...
    const [productName, setProductName] =  useState([{ name: "", harga: 0 }]);
    ...
    const addMore = () => {
        setProductName([...productName,  { name: "", harga: 0 }]);
    }
    ...
    return (
        <>
            <Head>
                <title>Create Product - Catering Aisyah</title>
            </Head>
            <LayoutAccount>
                    ...
                    <div className="col-12">
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            ...
                            <div className="card-body">
                                ...
                                <div className="col-md-12">
                                    <div className="alert alert-warning">
                                        <i className="fa fa-info-circle"></i>  add mix menu for you product.
                                    </div>
                                </div>
    ...
    <div className="row" key={index}>
        <div className="col-md-5">
            <div className="mb-3">
                ...
                <input type="text" name="name" value={elemen.name || ""} onChange={e => setProductNameku(index, e)} className="form-control" placeholder="Enter Size" />
            </div>
        </div>
