...
export default function ProductEdit() {
    ...
    const [productName, setProductName] = useState(product.product_mixes);
    ...
    const setProductNameku = (i, e) => {

        //copy array to new variable
        let newProductName = [...productName];

        //assign value
        newProductName[i][e.target.name] = e.target.value;
    ...
    return (
        <>
            <Head>
                <title>Edit Product - Catering Aisyah Purple</title>
            </Head>
            <LayoutAccount>
                        ...
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            ...
                            <div className="card-body">
                                <form onSubmit={updateProduct}>
                                    ...
                                    <div className="col-md-12">
                                        <div className="alert alert-warning">
                                        <i className="fa fa-info-circle"></i>  Add Name Menu Mixfor you product. 
                                        </div>
                                    </div>

                                    {productName.map((elemen, index) => (
                                        <div className="row" key={index}>
                                            <div className="col-md-5">
                                                <div className="mb-3">
                                                    <label className="form-label fw-bold">Name Menu mix</label>
                                                    <input type="text" name="name" value={elemen.name || ""} onChange={e => setProductNameku(index, e)} className="form-control" placeholder="Enter Name"/>
                                                </div>
                                            </div>
                                            <div className="col-md-5">
                                                    <div className="mb-3">
                                                        <label className="form-label fw-bold">Price</label>
                                                        <input type="number" name="harga" value={elemen.harga || ""} onChange={e => setProductNameku(index, e)} className="form-control" placeholder="Enter Price"/>
                                                    </div>
                                                </div>
                                           
                                            {
                                                index ?
                                                    <div className="col-md-2">
                                                        <div className="mb-3">
                                                            <label className="form-label fw-bold text-white">.</label>
                                                            <button type="button" className="btn btn-danger btn-md border-0 shadow-sm w-100" onClick={() => remove(index)}><i className="fa fa-trash"></i></button>
                                                        </div>
                                                    </div>
                                                : null
                                            }
                                    ...
                                    <div className="col-md-12">
                                        <button type="button" className="btn btn-primary btn-md border-0 shadow-sm" onClick={() => addMore()}><i className="fa fa-plus-circle"></i></button>
                                    </div>
