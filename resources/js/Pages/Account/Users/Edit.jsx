...
export default function UserEdit() {
    ...
    return (
        <>
            <Head>
                <title>Edit Users - Catering Aisyah</title>
            </Head>
            <LayoutAccount>
                            ...
                            <div className="card-body">
                                <form onSubmit={updateUser}>
                                    ...
                                    <div className="mb-6">
                                        ...
                                        <div className="col-md-6">
                                            <div className="mb-3">
                                                <label className="form-label fw-bold">Number whatsapp</label>
                                                <input type="number" className="form-control" value={number} onChange={(e) => setNumber(e.target.value)} placeholder="Enter Number Whatsapp" />
                                            </div>
                                            {errors.number && (
                                                <div className="alert alert-danger">
                                                    {errors.number}
