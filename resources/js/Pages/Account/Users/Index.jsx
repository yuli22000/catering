...
export default function UserIndex() {
    ...
    return(
        <>
            <Head>
                <title>Users - Catering Aisyah</title>
            </Head>
            <LayoutAccount>
                <div class="row mt-5">
                    <div class="col-md-8">
                                ...
                                <div className="table-responsive">
                                    <table className="table table-bordered table-striped table-hovered">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col" style={{ width: '10%' }}>Foto profil</th>
                                            <th scope="col" class="text-center" style={{ width: '30%' }}>Role</th>
                                        ...
                                        <tbody>
                                            {users.data.map((user, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <img src={user.avatar} className="rounded-3" width={'50'}/>
                                                    </td>
                                                    <td class="text-center">
