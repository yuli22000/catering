...
export default function Register() {
    ...
    return (
        <>
            <Head>
                <title>Register Account - Catering Aisyah</title>
            </Head>
                                ...
                                <form onSubmit={registerHandler}>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <div className="input-group mb-3">
                                                <span className="input-group-text"><i className="fa fa-user"></i></span>
                                                <input type="number" className="form-control" value={number} onChange={(e) => setNumber(e.target.value)} placeholder="Number Whatsapp" />
                                            </div>
                                            {errors.number && (
                                                <div className="alert alert-danger">
                                                    {errors.number}
