...
export default function CheckoutIndex() {
    ...
    const [grandSisa, setGrandSisa] = useState(0);
    const [grandDp, setGrandDp] = useState(0);
    ...
    const getServiceAndCost = (e) => {
        ...
        setGrandDp((parseInt(dataCarts.price) +  parseInt(shipping[0])) * 50/100);
        setGrandSisa((parseInt(dataCarts.price) +  parseInt(shipping[0])) * 50/100);
    ...
    return (
        <>
            <Head>
                <title>Checkouts - Catering Aisyah Purple</title>
            </Head>
            <LayoutWeb>
                            ...
                            <div className="col-md-8">
                                ...
                                <div className="card border-0 rounded-3 shadow-sm">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="mb-3">
                                            <label className="mb-2 fw-bold">Catatan</label>
                                            <textarea className="form-control" value={catatan} onChange={(e) => setCatatan(e.target.value)} rows="3" placeholder="Catatan"></textarea>
                                        </div>
                                        ...
                                        <div className="table-responsive">
                                            <table className="table mb-0 mt-0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td style={{ width: '25%' }}>Total Dp : </td>
                                                        <td style={{ width: '1%' }}>:</td>
                                                        <td><strong>Rp. {FormatPrice(grandDp)}</strong></td>
                                                    </tr>
                                                    <tr>
                                                        <td style={{ width: '25%' }}>Sisa Pembayaran : </td>
                                                        <td style={{ width: '1%' }}>:</td>
                                                        <td><strong>Rp. {FormatPrice(grandSisa)}</strong></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
