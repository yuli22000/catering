...
export default function CartIndex() {
    ...
    const { dataCarts, carts, countQty,totalPrice} = usePage().props;

    return (
        <>
            <Head>
                <title>Carts - Catering Aisyah </title>
            </Head>
            <LayoutWeb>
                                                                    ...
                                                                    <div className="card-body">
                                                                        ...
                                                                        <div className="row">
                                                                            <div className="col-md-12 col-12">
                                                                                ...
                                                                                <div className="mt-3">
                                                                                    Mix menu : <strong>{cart.name}</strong>
                                                                                </div>
                                                                            </div>
                                    ...
                                    <div className="col-md-12">
                                        <div className="card border-0 rounded-3 shadow-sm">
                                            <div className="card-body">
                                                ...
                                                <h6 className="mb-0">Quantity : <strong> {countQty.qty}</strong></h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-12 mt-4">
                                        {countQty.qty >= 5
                                            ? <Link href="/checkouts" className="btn btn-success btn-md border-0 shadow rounded-3 w-100"> DELIVERY <i className="fa fa-long-arrow-alt-right"></i></Link>
